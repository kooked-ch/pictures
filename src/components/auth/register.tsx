...
import { Camera, Github, Loader2, Lock, Mail, Sparkle, User } from 'lucide-react';
			...
			<Card className="shadow-lg border-accent md:border border-0">
				...
				<CardContent>
					...
					<form
						...
						<div className="space-y-2">
							...
							<div className="relative">
								...
								<Input type="text" placeholder="John Doe" className="pl-10" {...form.register('name')} />
							</div>
						...
						<div className="space-y-2">
							...
							<div className="relative">
								<Lock className="absolute left-3 top-2.5 h-4 w-4 text-muted-foreground" />
								<Input type="password" placeholder="••••••••" className="pl-10" {...form.register('confirmPassword')} />
							</div>
					...
					<div className="grid grid-cols-2 gap-4 mb-6">
						<Button variant="outline" className="hover:bg-background/50" onClick={() => signIn('github', { callbackUrl: searchParams.get('callbackUrl') || '/' })}>
						...
						<Button variant="outline" className="hover:bg-background/50" onClick={() => signIn('google', { callbackUrl: searchParams.get('callbackUrl') || '/' })}>
					...
					<form
						...
						<div>
							...
							<div className="relative">
								...
								<Input type="text" placeholder="Enter 6-digit code" {...codeForm.register('code')} className="w-full h-10 bg-accent/50 border-border focus:border-primary/50 focus:ring-primary/20 rounded-md text-center tracking-[0.5em] font-mono" maxLength={6} />
							</div>
